...
class GameScene2: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        place.position = CGPoint(x: 75, y: 0)
        
        player = SKSpriteNode(imageNamed: "squareBlue")
        player.position = CGPoint(x: 140, y: -30)
        item1 = SKSpriteNode(imageNamed: "squareBlue")
        item1.position = CGPoint(x: -75, y: 150)
        item2 = SKSpriteNode(imageNamed: "squareBlue")
        item2.position = CGPoint(x: 75, y: 150)
        item3 = SKSpriteNode(imageNamed: "squareBlue")
        item3.position = CGPoint(x: -75, y: 0)
        item4 = SKSpriteNode(imageNamed: "squareBlue")
        item4.position = CGPoint(x: -75, y: -150)
        item5 = SKSpriteNode(imageNamed: "squareBlue")
        item5.position = CGPoint(x: 75, y: -150)
